...
import id.ac.umn.week11_52738.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    class AsyncAmbilSemuaMahasiswa extends AsyncTask<Void, Void, List<Mahasiswa>> {
        ...
        protected void onPostExecute(List<Mahasiswa> mahasiswas) {
            ...
            adapter.setDaftarMahsiswa(mahasiswas);
        }
    }
    ...
    class AsyncTambahMahasiswa extends AsyncTask<Mahasiswa, Void, String>{
        ...
        protected void onPostExecute(String s) {
            ...
            if((s != null) && (s.equalsIgnoreCase("sukses"))){
                ...
                Toast.makeText(MainActivity.this,"Mahasiswa gagal ditmbahkan",Toast. LENGTH_LONG).show();
            }
        }
    }
    class AsyncUpdateMahasiswa extends AsyncTask<Mahasiswa, Void, String>{
        ...
        protected void onPostExecute(String s) {
            ...
            if((s != null) && (s.equalsIgnoreCase("sukses"))){
                ...
                Toast.makeText(MainActivity.this,"Oata Mahasiswa Berhasil diupdate", Toast.LENGTH_LONG).show();
            }else {
                Toast.makeText(MainActivity.this,"Oata Mahasiswa gagal diupdate",Toast. LENGTH_LONG).show();
            }
        }
    }
}
